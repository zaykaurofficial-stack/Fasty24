...
export default function ExpertTrackingMap({
  ...
  useEffect(() => {
    if (missingKey || !hostRef.current) return undefined;
    let cancelled = false;
    ...
    loadGoogleMapsJs()
      ...
      .catch(() => {
        // Fallback overlay still shows ETA without a map.
      });
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/8 bg-[#141414]">
      ...
      <div className="absolute left-3 right-3 bottom-3 rounded-xl bg-black/85 px-4 py-3">
